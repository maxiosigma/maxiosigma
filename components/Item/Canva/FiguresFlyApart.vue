<template>
   <kinesis-container :active="kinesis.active" :perspective="2000" class="flex-center inset-0 z-0 fixed">
      <div
      ...
      >
         <!-- 'rotate' -->
         <kinesis-element :strength="intRandom(50, 75)" :type="stringRandom(['depth', 'depth_inv', 'translate'])">
