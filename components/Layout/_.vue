...
.toast {
  &-cookie {
    //flex items-center
    @apply rounded-sm font-light pointer-events-none bg-cyan-900 bg-hero-wiggle-white-5 bg-opacity-100 bg-2r border-cyan-700 text-justify text-xs tracking-wider py-1 px-2 text-white/85 break-all #{!important};
