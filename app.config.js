const data = {
   ...
   description: "Сайт о личном росте, бизнесе, сотрудничестве, фрилансе, заработке, путешествиях, экономии, науке, творчестве и мышлении",
...
function meta() {
   return [
      ...
      { "http-equiv": "Content-Language", content: "ru" },
      {
         ...
         content: "public, max-age=7200, s-maxage=10800",
      },
