          ...
          <li class="confidentiality-subtitle">
            ...
            <ul class="confidentiality-sublist">
              <div>
                ...
                Семенюк Максим Валерьевич (далее – Оператор).
              </div>
          ...
          <li class="confidentiality-subtitle">
            ...
            <ul class="confidentiality-sublist">
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    содержащимся на веб-сайте <item-link href="/" />;
                  </li>
              ...
              <li>
                ...
                электронной почты {{ mail }} с пометкой «Отказ от уведомлений о новых продуктах и
          ...
          <li class="confidentiality-subtitle">
            ...
            <ul class="confidentiality-sublist">
              ...
              <li>
                ...
                на сайте <item-link href="/" /> или направленные Оператору посредством электронной
          ...
          <li class="confidentiality-subtitle">
            ...
            <ul class="confidentiality-sublist">
              ...
              <li>
                ...
                электронной почты Оператора {{ mail }} с пометкой «Актуализация персональных
                данных».
              </li>
              <li>
                ...
                посредством электронной почты на электронный адрес Оператора {{ mail }} с пометкой
