export const state = () => [
   { icon: "font-ft text-4xl font-ft-vk text-blue-500", href: "https://vk.com/maxiosigma" },
   { icon: "font-ft text-3xl font-ft-ins text-yellow-500", href: "https://www.instagram.com/maxiosigma" },
   { icon: "font-ft text-4xl font-ft-meta text-green-500 mb-0.25", href: "https://www.facebook.com/maxiosigma" },
   ...
   { icon: "font-ft text-2xl font-ft-tumblr text-blue-500 mr-0.5", href: "https://www.tumblr.com/blog/maxiosigma" },
   { icon: "font-ft text-4xl font-ft-ok text-yellow-500", href: "https://ok.ru/maxiosigma" },
];
